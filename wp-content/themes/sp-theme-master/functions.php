...
function sp_scripts()
{
	...
	wp_enqueue_style('cms-style', get_template_directory_uri() . '/css/style.css');
	wp_enqueue_style('mediascreen', get_template_directory_uri() . '/css/media.css');
